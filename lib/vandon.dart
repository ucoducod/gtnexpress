...
class Piegtn extends StatefulWidget {
  const Piegtn({Key key}) : super(key: key);

  @override
  _PiegtnState createState() => _PiegtnState();
}
// extends State<HotelHomeScreen> with TickerProviderStateMixin {
class _PiegtnState extends State<Piegtn> with TickerProviderStateMixin {
  ...
  //           final String stringBody = value.body;
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            //             ),
                            //           ),
                            //           // Icon(Icons.sort, color: HotelAppTheme.buildLightTheme().primaryColor),
                            //         ],
                            //       ),
                            //       const SizedBox(
                            //         height: 8,
                            ...
                            //           Flexible(
                            //             child: Text(
                            //               '${DateFormat('dd/MM/yyyy').format(DateTime.parse(_selectedDateRange.start.toString()).toLocal()).toString()} ${DateFormat('dd/MM/yyyy').format(DateTime.parse(_selectedDateRange.end.toString()).toLocal()).toString()}',
                            //               style: TextStyle(
                            //                 fontWeight: FontWeight.w400,
                            //                 fontSize: 14,
                            //               ),
  ...
  Widget _renderFilterSortByTag() {
    return Row(
      ...
      children: [
        ...
        //     ),
        //   ),
        // if (globals["startdatehh"]?.toIso8601String() != null || globals["enddatehh"]?.toIso8601String() != null )
        //   FilterLabel(
        //     label: "Hết hạn",
        //     onTap: () {
        //       // filterSortBy = filterSortBy.applyOnSale(null).applyFeatured(null);
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Padding(
            ...
            child:renderFilters(),
            // child: Row(
            //   mainAxisAlignment: MainAxisAlignment.spaceBetween,//add for start-end-new feature//spaceBetween
            //   children: <Widget>[
            //     Row(
            //         mainAxisAlignment: MainAxisAlignment.end,
            //         children: <Widget>[
            ...
            //                     children: <Widget>[
            //                       Text(
            //                         // '${DateFormat('dd/MM/yyyy').format(DateTime.parse(_selectedEndDate.toLocal().toString())).toString()}',
            //                         first_date_pick ?
            //                         '${DateFormat('dd/MM/yyyy').format(DateTime.parse(_selectedDateRange.start.toLocal().toString())).toString()} - ${DateFormat('dd/MM/yyyy').format(DateTime.parse(_selectedDateRange.end.toLocal().toString())).toString()}'
            //                         // '${DateFormat('dd/MM/yyyy').format(DateTime.parse(_selectedDateRange.end.toLocal().toString())).toString()}'
            //                             :
            //                         '${DateFormat('dd/MM/yyyy').format(DateTime.parse(_selectedDateRange.start.toLocal().toString())).toString()} - ${DateFormat('dd/MM/yyyy').format(DateTime.parse(_selectedDateRange.end.toLocal().toString())).toString()}',
            //                         style: TextStyle(
            ...
            //                         // child: Icon(Icons.sort,color: HotelAppTheme.buildLightTheme().primaryColor),
            //                         child: Icon(Icons.date_range,size: 20,color: HotelAppTheme.buildLightTheme().primaryColor),
            //                       ),
            //                     ],
            //                   ),
            //                 ),
            ...
            //     //             children: <Widget>[
            //     //               Text(
            //     //                 '${DateFormat('dd/MM/yyyy').format(DateTime.parse(_selectedStartDate.toLocal().toString())).toString()}',
            //     //                 style: TextStyle(
            //     //                   fontWeight: FontWeight.w500,
            //     //                   fontSize: 16,
            //     //                 ),
            ...
            //     //               // Text(
            //     //               //   first_date_pick ?
            //     //               //   //"${DateFormat('dd/MM/yyyy').format(DateTime.parse(_firstDateRange.start.toString()).toLocal()).toString()} ${DateFormat('dd/MM/y').format(DateTime.parse(_firstDateRange.end.toString()).toLocal()).toString()}"
            //     //               //   '${DateFormat('dd/MM/yyyy').format(DateTime.parse(_selectedDateRange.start.toLocal().toString())).toString()} ${DateFormat('dd/MM/yyyy').format(DateTime.parse(_selectedDateRange.end.toLocal().toString())).toString()}'
            //     //               //       :
            //     //               //   '${DateFormat('dd/MM/yyyy').format(DateTime.parse(_selectedDateRange.start.toLocal().toString())).toString()} ${DateFormat('dd/MM/yyyy').format(DateTime.parse(_selectedDateRange.end.toLocal().toString())).toString()}',
            //     //               //   style: TextStyle(
  ...
  void _awaitReturnValueFromSecondScreen(BuildContext context) async {
    ...
    setState(() {
      ...
      if (result != null) {
        ...
        // else if (text["Đã chuyển COD"]?.toString() == "true"){
        //   globals["comissionstatus"] = "paid";
        // }
        // else if (text["Chưa thanh toán"] != null && text["Chưa thanh toán"]=="true"){
        //   globals["comissionstatus"] = "not-paid";
        // } else {
        // else {
        //   // globals["comissionstatus"] = "all";
        ...
        //   }
        //   if (text["da chuyen cod:"]?.toString() == "true"){
  ...
  favoriteButton() {
    return FloatingActionButton.small(
      heroTag: "FloatingActionButton _firstLoad",
      onPressed: ()  {
...
class _FiltersScreenState extends State<FiltersScreen> {
  ...
  void checkAppPosition(int index) {
    print("checkAppPosition {$index}");
    if (index == 0) {
      print(accomodationListData[0].isSelected);
